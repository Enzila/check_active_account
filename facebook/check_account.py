...
def check_acc():
    ...
    read = open('facebook/log_facebook_account.txt', 'r')
    list = []
    for row in read:
    ...
    writecsv('facebook/FB_available_account.csv', active_account, ['user_id'])
    print (not_found_account)
    writecsv('facebook/FB_not_found_account.csv', not_found_account, ['user_id'])
